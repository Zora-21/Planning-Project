                        ...
                        if (maxGroupSize > 3) {
                            for (Ball rb : remainingBallsList) {
                                if (rb.getSize() > 1) {
                                    ...
                                    if (!inFocus)
                                        tie_breaker += (0.4 * amplifier); // Diventa +8.0 per multi-snowman!
                                }
                            }
                        }
