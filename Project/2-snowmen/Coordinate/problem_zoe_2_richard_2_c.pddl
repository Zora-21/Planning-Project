(define (problem zoe_2_richard_2_adapted)
    ...
    (:init
        ...
        (ball_at ball_1 loc_4_2) (= (ball_size ball_1) 3)
        (ball_at ball_2 loc_4_3) (= (ball_size ball_2) 2)
        (ball_at ball_3 loc_4_4) (= (ball_size ball_3) 1)
        (ball_at ball_4 loc_5_3) (= (ball_size ball_4) 1)
        (ball_at ball_5 loc_7_3) (= (ball_size ball_5) 1)
        ...
        (snow loc_7_1) (snow loc_7_2)                (snow loc_7_4) (snow loc_7_5)
    )
