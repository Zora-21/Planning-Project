(define (problem adapted_chris_karen_problem)
    (:domain two_snowman_coordinates)
    (:objects
        ball_0 ball_1 ball_2 ball_3 ball_4 ball_5 - ball
        
        loc_1_1 loc_1_2 loc_1_3 loc_1_4 loc_1_5 loc_1_6 - location
        loc_2_1 loc_2_2 loc_2_3 loc_2_4 loc_2_5 loc_2_6 - location
        loc_3_1 loc_3_2 loc_3_3 loc_3_4 loc_3_5 loc_3_6 - location
        loc_4_1 loc_4_2 loc_4_3 loc_4_4 loc_4_5 loc_4_6 - location
        loc_5_1 loc_5_2 loc_5_3 loc_5_4 loc_5_5 loc_5_6 - location
        loc_6_1 loc_6_2 loc_6_3 loc_6_4 loc_6_5 loc_6_6 - location
    )
    (:init
        ;; --- Funzioni Numeriche Base ---
        (= (total-cost) 0)
        (= (snowman_built) 0)
