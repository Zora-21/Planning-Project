(define (problem kate-adapted-for-coordinates)
    (:domain one_snowman_coordinates)

    (:objects
        ;; Problem objects: 3 balls and 32 locations
        ball_0 ball_1 ball_2 - ball
        
        loc_1_1 loc_1_2 loc_1_3 loc_1_4
        loc_2_1 loc_2_2 loc_2_3 loc_2_4
        loc_3_1 loc_3_3 loc_3_4
        loc_4_1 loc_4_3 loc_4_4
        loc_5_1 loc_5_3 loc_5_4
    ...
    (:init
        ...
        (snow loc_1_1) (snow loc_1_2) (snow loc_1_3) (snow loc_1_4)
        (snow loc_2_1) (snow loc_2_3) (snow loc_2_4)
        (snow loc_3_1) (snow loc_3_3) (snow loc_3_4)
        (snow loc_4_1) (snow loc_4_4)
        (snow loc_5_1) (snow loc_5_3) (snow loc_5_4)
        (snow loc_6_1) (snow loc_6_3) (snow loc_6_4)
