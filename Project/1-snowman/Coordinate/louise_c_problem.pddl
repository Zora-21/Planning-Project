(define (problem louise-adapted-for-coordinates)
    (:domain one_snowman_coordinates)

    (:objects
        ;; Problem objects: 3 balls and 28 locations
        ...
        loc_5_1 loc_5_2 loc_5_3 loc_5_4 - location
    )
    ...
    (:init
        ...
        (snow loc_3_1)
        (snow loc_4_1) (snow loc_4_3) (snow loc_4_4)
